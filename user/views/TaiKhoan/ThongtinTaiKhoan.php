...
<body>
    ...
    <div class="container">
        ...
        <div class="sidebar">
            <h2>TÀI KHOẢN BFH</h2>
            <ul>
                <li><a href="#" class="active">Thông Tin Chung</a></li>
        ...
        <div class="content">
            ...
            <div class="profile">
                <div class="profile-info">
                    <p><span>Tên:</span><?= $account['username'] ?></p>
                ...
                <div class="profile-avatar">
                    <img src="<?= BASE_URL_USER . $account['thumbnail'] ?>"
            ...
            <div class="footer">
                <p>© 2024 <?= $account['full_name'] ?> - Tất cả các quyền được bảo lưu.</p>
            </div>
        </div>
    </div>
